...
## Corpus Check
- 33 files · ~29,157 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 781 nodes · 1078 edges · 31 communities (26 shown, 5 thin omitted)
...
- `build` --references--> `AdminState`  [EXTRACTED]
  lib/screens/orders_screens.dart → lib/state.dart
...
Cohesion: 0.06
Nodes (36): DateTime, activityFilter, activitySince, allCarpenters, app, bannerUrl, build, _CarpenterPicker (+28 more)
...
Cohesion: 0.10
Nodes (21): GoRouter?, AdminRouterProvider, _AdminRouterProviderState, createState, _router, login_screen.dart, screens/carpenter_detail_screen.dart, screens/carpenters_screens.dart (+13 more)
...
Cohesion: 0.11
Nodes (16): firebase_options.dart, currentPlatform, DefaultFirebaseOptions, web, _app, build, createState, initializeApp (+8 more)

### Community 13 - "StatelessWidget"
Cohesion: 0.10
Nodes (20): OfferDetailScreen, OrderStatusStepper, _StatusActions, _OrderCard, AppCard, AudienceBadge, Avatar, BackLink (+12 more)

### Community 14 - "settings_screen.dart"
Cohesion: 0.09
Nodes (29): AdminConsoleApp, _AdminConsoleAppState, amount, app, _AppVersionForm, _AppVersionFormState, build, buildNumber (+21 more)

### Community 15 - "carpenters_screens.dart"
Cohesion: 0.06
Nodes (34): IconData, Carpenter, build, carpenter, CarpentersScreen, _CarpentersScreenState, _CarpenterTile, createState (+26 more)

### Community 16 - "carpenter_detail_screen.dart"
Cohesion: 0.11
Nodes (19): CarpenterDetailScreen, _CarpenterDetailScreenState, carpenterId, createState, icon, label, _leadsTab, _MiniStat (+11 more)
...
Cohesion: 0.18
Nodes (11): body, createState, NotificationsScreen, _NotificationsScreenState, _page, _perPage, sending, submitted (+3 more)

### Community 24 - "AdminState"
Cohesion: 0.20
Nodes (12): ChangeNotifier, build, build, buildAdminRouter, build, build, build, build (+4 more)
...
Cohesion: 0.29
Nodes (7): createState, email, LoginScreen, _LoginScreenState, password, package:provider/provider.dart, widgets.dart
...
## Knowledge Gaps
- **555 isolated node(s):** `CloudinaryService`, `_imageExtensions`, `_pdfExtensions`, `_maxDimension`, `_jpegQuality` (+550 more)
