...
## Corpus Check
- 35 files · ~34,844 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 885 nodes · 1212 edges · 35 communities (28 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `babe90b8`
...
- `build` --references--> `AdminState`  [EXTRACTED]
  lib/screens/feedback_screen.dart → lib/state.dart
...
Cohesion: 0.02
Nodes (122): Color, dart:ui, actions, build, buildAdminTheme, buttonLabel, cancelLabel, cells (+114 more)

### Community 1 - "state.dart"
Cohesion: 0.02
Nodes (99): dart:async, firebase_service.dart, addGift, addOffer, addOrderComment, addPartyOrder, adminEmail, appBuildNumber (+91 more)
...
Cohesion: 0.07
Nodes (30): DateTime, activityFilter, activitySince, allCarpenters, app, bannerUrl, category, _close (+22 more)

### Community 5 - "order_detail_screen.dart"
Cohesion: 0.05
Nodes (38): amountCtrl, _bubble, _comments, createState, dispose, effectiveStatus, _field, _fmtWhen (+30 more)
...
Cohesion: 0.06
Nodes (37): PartyOrder, _amt, approveAmt, _approveCard, _approvePrefilled, build, busy, createState (+29 more)

### Community 8 - "creator_home_screen.dart"
Cohesion: 0.06
Nodes (31): int get, amount, _amt, carpenterId, carpenterName, carpSearch, createState, error (+23 more)
...
Cohesion: 0.17
Nodes (12): body, build, createState, NotificationsScreen, _NotificationsScreenState, _page, _perPage, sending (+4 more)
...
Cohesion: 0.08
Nodes (25): _CreatorOrderCard, _PartyStatusChip, OrderStatusStepper, _StatusActions, AppCard, AudienceBadge, Avatar, BackLink (+17 more)

### Community 14 - "settings_screen.dart"
Cohesion: 0.09
Nodes (23): amount, app, _AppVersionForm, _AppVersionFormState, build, buildNumber, converted, createState (+15 more)
...
Cohesion: 0.17
Nodes (12): Redemption, app, build, createState, _page, _perPage, redemption, _RedemptionCard (+4 more)
...
Cohesion: 0.11
Nodes (19): carpenter, CarpenterDetailScreen, _CarpenterDetailScreenState, carpenterId, createState, _Detail, label, _leadsTab (+11 more)

### Community 24 - "AdminState"
Cohesion: 0.20
Nodes (12): ChangeNotifier, build, build, build, OfferDetailScreen, build, initState, _send (+4 more)
...
### Community 30 - "State"
Cohesion: 0.17
Nodes (16): CreatorHomeScreen, _CreatorHomeScreenState, _PartyOrderDialog, _PartyOrderDialogState, _RecordPaymentDialog, _RecordPaymentDialogState, _CarpenterPicker, _CarpenterPickerState (+8 more)

### Community 31 - "feedback_screen.dart"
Cohesion: 0.15
Nodes (13): FeedbackEntry, app, build, createState, entry, _FeedbackCard, FeedbackScreen, _FeedbackScreenState (+5 more)

## Knowledge Gaps
- **636 isolated node(s):** `CloudinaryService`, `_imageExtensions`, `_pdfExtensions`, `_maxDimension`, `_jpegQuality` (+631 more)
...
- **Why does `AdminState` connect `AdminState` to `state.dart`, `offers_screens.dart`, `order_detail_screen.dart`, `orders_screens.dart`, `party_orders_screen.dart`, `creator_home_screen.dart`, `router.dart`, `dashboard_screen.dart`, `gifts_screens.dart`, `main.dart`, `settings_screen.dart`, `carpenters_screens.dart`, `carpenter_detail_screen.dart`, `leads_screen.dart`, `redemptions_screen.dart`, `locations_screen.dart`, `AdminState`, `package:provider/provider.dart`, `State`, `feedback_screen.dart`, `build`, `build`, `_OffersScreenState`?**
