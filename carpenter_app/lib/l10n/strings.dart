...
const Map<String, String> hiStrings = {
  'Unlock to continue': 'जारी रखने के लिए अनलॉक करें',
  'Use your fingerprint, face or PIN to log in': 'लॉगिन करने के लिए फिंगरप्रिंट, फेस या PIN इस्तेमाल करें',
  'Unlock': 'अनलॉक करें',
  'Use password instead': 'पासवर्ड से लॉगिन करें',
  'Verify your identity to log in': 'लॉगिन करने के लिए अपनी पहचान सत्यापित करें',
  ...
  'Set up PIN': 'PIN सेट करें',
  'Set up a PIN': 'PIN सेट करें',
  'Add a 4-digit PIN for quick and secure access to your account.': 'अपने खाते की जल्दी और सुरक्षित पहुंच के लिए 4 अंकों का PIN बनाएं।',
  'Create a 4-digit PIN': '4 अंकों का PIN बनाएं',
  'This PIN will be used to quickly access your account': 'इस PIN का इस्तेमाल आपके खाते में जल्दी पहुंचने के लिए होगा',
  'Confirm your PIN': 'अपना PIN पुष्टि करें',
  'Enter the same PIN again to confirm': 'पुष्टि करने के लिए वही PIN फिर से डालें',
  'PINs do not match. Try again.': 'PIN मेल नहीं खाते। फिर से कोशिश करें।',
  'Could not save PIN. Try again.': 'PIN सेव नहीं हो सका। फिर से कोशिश करें।',
  'Skip': 'छोड़ें',
  'Change PIN': 'PIN बदलें',
  'Enter current PIN': 'मौजूदा PIN डालें',
  'Verify your identity before changing PIN': 'PIN बदलने से पहले अपनी पहचान सत्यापित करें',
  'Incorrect PIN': 'गलत PIN',
  'Create a new PIN': 'नया PIN बनाएं',
  'Enter a new 4-digit PIN': 'नया 4 अंकों का PIN डालें',
  'PIN changed successfully': 'PIN सफलतापूर्वक बदला गया',
  '4-digit PIN (optional)': '4 अंकों का PIN (वैकल्पिक)',
  'For quick access to your account': 'अपने खाते में जल्दी पहुंचने के लिए',
  'PIN must be exactly 4 digits': 'PIN ठीक 4 अंकों का होना चाहिए',
  'Last logged in': 'पिछली बार लॉगिन किया',
  'Use this account': 'इस खाते का इस्तेमाल करें',
  'Log in with another account': 'दूसरे खाते से लॉगिन करें',
  'Enter PIN': 'PIN डालें',
  'Enter your PIN': 'अपना PIN डालें',
  'Enter your 4-digit PIN to continue': 'जारी रखने के लिए अपना 4 अंकों का PIN डालें',
  'Use PIN instead': 'PIN से लॉगिन करें',
  'Enter your mobile number or email': 'अपना मोबाइल नंबर या ईमेल डालें',
  'Enter a valid 4-digit PIN': 'सही 4 अंकों का PIN डालें',
  'PIN login is not available for this account': 'इस खाते के लिए PIN लॉगिन उपलब्ध नहीं है',
  'Saved credentials not found. Please use password.': 'सहेजी गई जानकारी नहीं मिली। कृपया पासवर्ड इस्तेमाल करें।',
  'Choose login method': 'लॉगिन का तरीका चुनें',
  'Logging in as': 'लॉगिन हो रहा है',
  'Try biometric again': 'बायोमेट्रिक फिर से आज़माएं',
  'Use PIN': 'PIN इस्तेमाल करें',
  'Use password': 'पासवर्ड इस्तेमाल करें',
  'Enable biometric login': 'बायोमेट्रिक लॉगिन चालू करें',
  'Use fingerprint or face to log in quickly next time?': 'अगली बार जल्दी लॉगिन के लिए फिंगरप्रिंट या फेस इस्तेमाल करें?',
  'Not now': 'अभी नहीं',
  'Enable': 'चालू करें',
  'Too many failed attempts': 'बहुत ज़्यादा गलत कोशिशें',
  'Please use your password to log in.': 'कृपया लॉगिन के लिए पासवर्ड इस्तेमाल करें।',
  'PIN is not set up. Use password to log in.': 'PIN सेट नहीं है। लॉगिन के लिए पासवर्ड इस्तेमाल करें।',
  '{n} attempts remaining': '{n} कोशिशें बाकी',
  'Security update required': 'सुरक्षा अपडेट ज़रूरी है',
  'The admin has requested you to update your security settings. Please complete the following to continue.': 'एडमिन ने आपसे सुरक्षा सेटिंग्स अपडेट करने का अनुरोध किया है। जारी रखने के लिए निम्नलिखित पूरा करें।',
